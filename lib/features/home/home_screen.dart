  ...
  Widget _buildNotesList() {
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        padding: const EdgeInsets.symmetric(horizontal: GraphiteSpacing.pageInset, vertical: GraphiteSpacing.sm),
        ...
        children: [
          ...
          Expanded(
            child: Text(
              ...
              style: GraphiteTypography.label.copyWith(color: scheme.secondary, fontWeight: FontWeight.w600),
            ),
          ),
          IconButton(
